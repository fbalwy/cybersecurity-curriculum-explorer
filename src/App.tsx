...
function initialState() {
  ...
  const focusMode: FocusMode =
    requestedMode === 'direct' || requestedMode === 'full' || requestedMode === 'direct-unlocks' || requestedMode === 'unlocks'
      ? requestedMode
      : 'direct-unlocks'
